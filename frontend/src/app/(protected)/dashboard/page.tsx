...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Robotics Automation Operations Dashboard"
      subtitle="One merged robotics automation operations view for Records, Workspaces, Requests, Cases, Schedules, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared robotics automation operations jobs into one surface. Records, Workspaces, Requests, Cases, Schedules, Resources, documents, audit, and AI are presented as platform features.</div>
