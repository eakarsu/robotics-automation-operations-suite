...
export default function LoginPage() {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    setSubmitting(false);
    if (!ok) {
      setError('Use the seeded robotics automation operations suite demo credentials.');
      return;
    }
  ...
  return (
    <div className="auth-wrap">
      <div className="auth-card">
        <div className="pill">Robotics Automation Operations</div>
        <h1 style={{ marginBottom: 8 }}>Unified healthcare login</h1>
        <div className="muted">
          One login for robotics automation operations features, documents, notifications, audit, approvals, and AI operations.
        </div>
