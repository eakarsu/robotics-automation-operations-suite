export const AUTH_COOKIE = 'robotics_automation_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@robotics-automation-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@robotics-automation-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@robotics-automation-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
