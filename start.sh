...
PORT="${PORT:-4800}"
DB_NAME="${PGDATABASE:-robotics_automation_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Robotics Automation Operations Suite"
echo "======================================="
echo
...
echo "Starting robotics automation operations suite frontend on http://localhost:$PORT"
echo "Login: admin@robotics-automation-operations.local / admin123"
